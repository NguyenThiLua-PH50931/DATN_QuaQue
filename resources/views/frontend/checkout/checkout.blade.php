...
<div style="position: fixed; top: 32px; right: 32px; z-index: 1055; min-width:320px;max-width:90vw;">
    @if(session('success'))
        <div class="alert alert-success alert-dismissible shadow rounded-3 fade show mb-2 px-4 py-3 fs-6" role="alert">
            <i class="fa fa-check-circle me-2"></i> {{ session('success') }}
            <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
        </div>
    @endif
    @if(session('error'))
        <div class="alert alert-danger alert-dismissible shadow rounded-3 fade show mb-2 px-4 py-3 fs-6" role="alert">
                                                    ...
                                                    @foreach ($shippingMethods as $method)
                                                        <div class="col-xxl-6">
                                                            <div class="delivery-option">
                                                                <div class="form-check custom-form-check d-flex align-items-center">
                                                                    ...
                                                                    <label class="form-check-label" for="shipping_method_{{ $method->id }}">
                                                                        {{ $method->name }} <span>({{ $method->description }})</span>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                             ...
                                             <script>
                                               document.querySelectorAll('input[name="shipping_method_id"]').forEach(function(radio) {
                                                    radio.addEventListener('change', function() {
                                                        ...
                                                        .then(data => {
                                                            document.getElementById('shipping-fee').innerText = data.shipping_cost.toLocaleString('vi-VN') + ' VNĐ';
                                                            document.getElementById('total-amount').innerText = data.total.toLocaleString('vi-VN') + ' VNĐ';
                                                            document.getElementById('subtotal-amount').innerText = data.subtotal.toLocaleString('vi-VN') + ' VNĐ';
                                                            document.getElementById('discount-amount').innerText = '-' + data.discount_amount.toLocaleString('vi-VN') + ' VNĐ';

                                                            // Update QR code TPBank
                                                            var qrUrl = "https://img.vietqr.io/image/TPB-00005320304-compact2.png?amount=" + data.total + "&addInfo=" + encodeURIComponent('Thanh toan don tam') + "&accountName=" + encodeURIComponent('VU VAN QUAN');
                                                    ...
                                                    <div class="accordion accordion-flush custom-accordion"
                                                        ...
                                                        <div class="accordion-item">
                                                                ...
                                                                <div class="accordion-button collapsed"
                                                                    ...
                                                                    <div class="custom-form-check form-check mb-0">
                                                                        <label class="form-check-label" for="cash"><input
                                                                                ...
                                                                                name="payment_method" id="cash" value="cod" checked> Thanh toán khi nhận hàng</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div id="flush-collapseFour"
                                                                ...
                                                                <div class="accordion-body">
                                                                    <p class="cod-review">Thanh toán khi nhận hàng, giúp bạn yên tâm và thuận tiện hơn trong mỗi giao dịch!
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="accordion-item">
                                                                ...
                                                                <div class="accordion-button collapsed"
                                                                    ...
                                                                    <div class="custom-form-check form-check mb-0">
                                                                        <label class="form-check-label" for="banking"><input
                                                                                class="form-check-input mt-0" type="radio"
                                                                                name="payment_method" id="banking" value="bank">Chuyển khoản ngân hàng
                                                                            </label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                                                data-bs-parent="#accordionFlushExample">
                                                                <div class="accordion-body">
                                                                    <p class="cod-review">Với phương thức chuyển khoản ngân hàng, bạn có thể dễ dàng thanh toán nhanh chóng và an toàn.</p>
                                                                    <div class="row g-2">
                                                                        <div class="col-md-6 text-center">
                                                                            @php
                                                                                ...
                                                                                $qrUrl = "https://img.vietqr.io/image/{$bankCode}-{$accountNumber}-compact2.png?amount={$amount}&addInfo=" . urlencode($addInfo) . "&accountName=" . urlencode($accountName);
                                                                            @endphp
                                                                            <img id="qr-bank"
                                                                                src="{{ $qrUrl }}"
                                                                            ...
                                                                            <div style="font-size:15px">
                                                                                <span class="text-danger small">* Quét mã bằng app ngân hàng. Đảm bảo đúng số tiền và nội dung chuyển khoản!</span>
                                                                            </div>
                                                                            <!-- Nút xác nhận chuyển khoản -->
                                                                            <button type="button" class="btn btn-warning mt-3" id="btn-bank-confirm">Tôi đã chuyển khoản</button>
                                                                            <div id="bank-confirm-message" class="mt-2 text-success" style="display: none;">
                                                                                Cảm ơn bạn! Shop đã ghi nhận xác nhận chuyển khoản của bạn.
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                            ...
                            <div class="right-side-summery-box">
                                <div class="summery-box-2">
                                    ...
                                    <ul class="summery-total">
                                        <li>
                                            <h4>Tạm tính</h4>
                                            <h4 id="subtotal-amount" class="price">{{ number_format($subtotal, 0, ',', '.') }} VNĐ</h4>
                                        </li>
                                        <li>
                                ...
                                <div class="checkout-offer">
                                    <div class="offer-title">
                                        <div class="offer-icon">
                                            <img src="../frontend/assets/images/inner-page/offer.svg" class="img-fluid" alt="">
                                        </div>
...
<!-- Đặt ở ngay trên nút Đặt hàng hoặc trước </form> đều được -->
                                <input type="hidden" name="bank_transfer_confirmed" id="bank_transfer_confirmed_input" value="0">
                                <button type="submit" id="submit-order-btn" class="btn theme-bg-color text-white btn-md w-100 mt-4 fw-bold">Đặt hàng</button>
                            </div>
                        </div>
                    </div>
                </form>
