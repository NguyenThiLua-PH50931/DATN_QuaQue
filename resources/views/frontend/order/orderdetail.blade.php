    ...
    <div class="row g-4 flex-lg-row flex-column-reverse">
        ...
        <div class="col-lg-4">
            ...
            <div class="border rounded-4 p-4 bg-white mb-4 shadow-sm">
                ...
                <div class="d-flex justify-content-between"><span>Tổng tiền hàng:</span><span>{{ number_format($subtotal, 0, ',', '.') }} VNĐ</span></div>
                @if ($order->free_shipping_code)
                    ...
                    <div class="row g-0 align-items-center">
                        ...
                        <div class="col ps-0">
                            <div class="card-body p-2">
                                <div class="fw-bold fs-5 mb-1"><a class="fw-bold fs-5 mb-1" href="{{ route('client.product.detail', ['slug' => $item->product->slug]) }}">{{ $item->product_name }}</a></div>
                                ...
                                <div class="d-flex justify-content-end mt-2 gap-2">
                                    ...
                                    {{-- Nút mua lại --}}
                                    <a href="#"
                                        class="btn fw-bold cl-btn btn-cartstorequick"
                                        data-product-id="{{ $item->product_id }}"
        ...
        <form method="POST" action="{{ route('client.orders.cancel', $order->id) }}">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="btn btn-outline-secondary fw-bold" data-bs-dismiss="modal">Đóng</button>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3 mt-1">
                        ...
                        <textarea class="form-control" id="content" name="content"
                            rows="3" placeholder="Nhập đánh giá..."></textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn fw-bold cl-btn" data-bs-dismiss="modal">Đóng</button>
                    <button type="submit" class="btn fw-bold" style="background-color: #0da487; color: white;">Gửi đánh giá</button>
                </div>
            </form>
        </div>
    </div>
...
<div id="reviewToast" class="toast position-fixed top-0 end-0 m-3" role="alert" aria-live="assertive" aria-atomic="true" data-bs-delay="2000" style="z-index:9999;">
