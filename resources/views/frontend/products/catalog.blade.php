...
? (is_array(request('dm')) ? request('dm') : explode(',', request('dm')))
: [];
$regionSelected = request()->has('regions')
? (is_array(request('regions')) ? request('regions') : explode(',', request('regions')))
: [];
$ratingSelected = request()->has('rating')
? (is_array(request('rating')) ? request('rating') : explode(',', request('rating')))
: [];
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne">
                                    <div class="accordion-body">
                                        <div class="form-floating theme-form-floating-2 search-box">
                                            <input type="search" class="form-control" id="category-search" placeholder="Tìm danh mục .." />
                                ...
                                <div id="collapseTwo" class="accordion-collapse collapse show" aria-labelledby="headingTwo">
                                    <div class="accordion-body">
                                        <ul class="category-list custom-padding" id="region-filter-list">
                                            ...
                                            <li>
                                                <div class="form-check ps-0 m-0 category-list-box">
                                                    <input class="checkbox_animated region-checkbox"
                                                        type="checkbox"
                                                        id="region-{{ $region->id }}"
                                                        value="{{ $region->id }}"
                                                        @if($checked) checked @endif />
                                    ...
                                    <div class="accordion-body">
                                        <div class="range-slider">
                                            <input type="text"
                                                ...
                                                data-min="0"
                                                data-max="10000000"
                                                data-from="{{ (int) $minPrice }}"
                                                data-to="{{ (int) $maxPrice }}"
                                                data-step="10000"
                                                data-prefix="₫" />
                                        </div>
                                    </div>
                ...
                <div class="category-dropdown">
                    ...
                    <div class="dropdown">
                        <button class="dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                            <span id="current-sort-text" data-sort="{{ $currentSort }}">{{ $currentSortText }}</span>
                ...
                <div class="grid-option d-none d-md-block">
                    <ul>
                        ...
                        <li class="grid-btn d-xxl-inline-block d-none active">
                            <a href="javascript:void(0)">
                                <img src="{{ asset('frontend/assets/svg/grid-4.svg') }}" class="blur-up lazyload d-lg-inline-block d-none" alt="" />
                                <img src="{{ asset('frontend/assets/svg/grid.svg') }}" class="blur-up lazyload img-fluid d-lg-none d-inline-block" alt="" />
                            </a>
                        </li>
                        <li class="list-btn">
                            <a href="javascript:void(0)">
                        ...
                        <div class="product-footer">
                            <div class="product-detail">
                                ...
                                <span class="span-name">
                                    {{ $showCategories->join(', ') }} @if($more) ... @endif
                                </span>
