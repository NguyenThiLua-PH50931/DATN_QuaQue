                    ...
                    <div class="col-xxl-8 col-lg-10 m-auto">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('admin.attributes.update', $attribute->slug) }}"
                                    ...
                                    <div class="mb-4 row align-items-start">
                                        ...
                                        <div class="col-sm-9">
                                                    ...
                                                    @foreach ($inputValues as $index => $value)
                                                        <div class="d-flex mb-2 attribute-value-row align-items-center">
                                                            <input
                                                                ...
                                                                type="text" name="values[]" value="{{ $value }}"
                                                                placeholder="Nhập giá trị thuộc tính">
                                                            <button type="button"
                                                                class="btn btn-outline-danger btn-remove-value">Remove</button>
                                                            @error('values.' . $index)
                                                                <small
                                                                    class="text-danger ms-3 mt-1 d-block">{{ $message }}</small>
                                                            @enderror
                                                        </div>
                                                    @endforeach
                                                @else
                                                    <div class="d-flex mb-2 attribute-value-row align-items-center">
                                                        <input class="form-control me-3" type="text" name="values[]"
                                                            placeholder="Nhập giá trị thuộc tính">
                                                        <button type="button"
                                                            class="btn btn-outline-danger btn-remove-value">Remove</button>
                                                    </div>
                                            ...
                                            <button type="button" id="btn-add-value" class="btn btn-primary mt-2">Add
                                                Value</button>
                                            @error('values.*')
                                    ...
                                    <button type="submit" class="btn theme-bg-color text-white">Cập nhật</button>
                                </form>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#btn-add-value').click(function() {
                var newInput = `
                <div class="d-flex mb-2 attribute-value-row align-items-center">
                    <input class="form-control me-3" type="text" name="values[]" placeholder="Nhập giá trị thuộc tính">
