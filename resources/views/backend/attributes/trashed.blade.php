                    ...
                    <div class="card card-table">
                        <div class="card-body">
                            ...
                            {{-- <small class="text-muted">
                                ...
                                <strong>Lưu ý:</strong> Các thuộc tính đã xóa mềm sẽ được tự động xóa vĩnh viễn sau 30 ngày.
                            </small> --}}
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#check-auto-delete-btn').click(function() {
                ...
                $.ajax({
                    url: '{{ route('admin.attributes.checkAutoDeleteStatus') }}',
                    method: 'GET',
                    dataType: 'json',
                    success: function(response) {
                        console.log('Auto delete status response:', response);
                        let content = '<div class="row">';
                        content += '<div class="col-md-6"><strong>Tổng số thuộc tính đã xóa:</strong> ' + response.total + '</div>';
                        ...
                        if (response.days_until_auto_delete.length > 0) {
                            ...
                            content += '<thead><tr><th>Thuộc tính</th><th>Còn lại</th><th>Ngày xóa</th></tr></thead><tbody>';
                            ...
                            content += '<p class="text-muted">Không có thuộc tính nào trong thùng rác.</p>';
                        }
