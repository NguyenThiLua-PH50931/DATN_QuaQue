                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="theme-form theme-form-2 mega-form" method="POST"
                                        action="{{ route('admin.coupon.store') }}" novalidate>
                                        @csrf
                                        <div class="row">
                                            ...
                                            <div class="mb-4 row align-items-center group-global">
                                                ...
                                                <div class="col-md-9 col-lg-10">
                                                    <select class="form-select" name="scope" id="scope" required>
                                                        <option value="global"
                                                            {{ old('scope', 'global') == 'global' ? 'selected' : '' }}>Toàn
                                                            hệ thống</option>
                                                        <option value="conditional"
                                                            {{ old('scope') == 'conditional' ? 'selected' : '' }}>Theo điều
                                                            kiện</option>
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-9 col-lg-10">
                                                    <select class="form-select" name="condition_type" id="condition_type">
                                                        ...
                                                        <option value="new_user_30d"
                                                            {{ old('condition_type') === 'new_user_30d' ? 'selected' : '' }}>
                                                            Tài khoản đăng ký dưới 30 ngày (Freeship)
                                                        </option>
                                                        <option value="first_order"
                                                            {{ old('condition_type') === 'first_order' ? 'selected' : '' }}>
                                            ...
                                            <div class="mb-4 row align-items-center group-usage group-global"
                                                ...
                                                <div class="col-md-9 col-lg-10">
                                                    <input class="form-control" type="number" name="usage_limit"
                                                        id="usage_limit" value="{{ old('usage_limit', 1) }}" min="1"
                                                        required>
                                                    @error('usage_limit')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                ...
                                                <div class="col-md-9 col-lg-10">
                                                    <select class="form-select" name="type" id="discount-type-select"
                                                        ...
                                                        <option value="order_discount"
                                                            {{ old('type') == 'order_discount' ? 'selected' : '' }}>Giảm
                                                            giá đơn hàng</option>
                                                        <option value="free_shipping"
                                                            {{ old('type') == 'free_shipping' ? 'selected' : '' }}>Miễn phí
                                                            vận chuyển</option>
                                                    </select>
                                                    @error('type')
                                                        <div class="text-danger">{{ $message }}</div>
                                            ...
                                            <div class="mb-4 row align-items-center group-discount" id="discount-type-row">
                                                ...
                                                <div class="col-md-9 col-lg-10">
                                                    <select class="form-select" name="discount_type">
                                                        <option disabled {{ old('discount_type') ? '' : 'selected' }}>
                                                            --Chọn--</option>
                                                        <option value="percent"
                                                            {{ old('discount_type') == 'percent' ? 'selected' : '' }}>Phần
                                                            trăm</option>
                                                        <option value="fixed"
                                                            {{ old('discount_type') == 'fixed' ? 'selected' : '' }}>Tiền cố
                                                            định</option>
                                                    </select>
                                                    @error('discount_type')
                                                        <div class="text-danger">{{ $message }}</div>
                                            ...
                                            <div class="mb-4 row align-items-center group-discount group-global">
                                                ...
                                                <div class="col-md-9 col-lg-10">
                                                    <input class="form-control" type="number" name="used_count"
                                                        value="{{ old('used_count', 0) }}" readonly>
                                                    @error('used_count')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                ...
                function updateFormFields() {
                    ...
                    if (scope === 'conditional') {
                        ...
                        if (conditionType && conditionConfig[conditionType]) {
                            ...
                            // Chọn & khóa loại mã theo condition
                            if (typeSelect) {
