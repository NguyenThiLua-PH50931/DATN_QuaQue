                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="GET" action="{{ route('admin.comments.index') }}" class="mb-4">
                            <div class="row g-3">
                                <div class="col-md-4">
                                    <input type="text" name="search" class="form-control" placeholder="Tìm kiếm theo nội dung, người dùng, sản phẩm..." value="{{ request('search') }}">
                                </div>
                                <div class="col-md-3">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="action-buttons">
                                                    ...
                                                    <a href="{{ route('admin.comments.reply', $comment->id) }}" class="btn btn-info btn-sm">Trả lời</a>
                                                </div>
                                            </td>
                                        </tr>
                                    @empty
