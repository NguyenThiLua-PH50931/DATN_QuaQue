                        ...
                        <div class="card-body">
                            <div class="title-header title-header-block package-card">
                                ...
                                <div class="card-order-section">
                                    <ul>
                                        <li>{{ $order->created_at->format('m, d, Y') }} lúc
                                            {{ $order->created_at->format('H:i') }}</li>
                                    ...
                                    <div class="col-xl-8">
                                        <div class="table-responsive table-details">
                                            <table class="table cart-table table-borderless">
                                                ...
                                                <tbody>
                                                    @foreach ($order->items as $item)
                                                        <tr class="table-order">
                                                            ...
                                                            <td
                                                                style="max-width: 200px; word-break: break-word; white-space: normal;">
                                                ...
                                                <tfoot>
                                                    @php
                                                        // Tính tạm tính: tổng (giá * số lượng)
                                                        $subtotal = $order->items->sum(function ($item) {
                                                            return $item->price * $item->quantity;
                                                        });

                                                        // Tính tổng giảm giá: tổng (giảm giá * số lượng)
                                                        ...
                                                        // Tổng cộng = Tạm tính + vận chuyển - giảm giá
                                                    ...
                                                    <tr class="table-order">
                                                        ...
                                                        <td colspan="2">
                                                            <h5 class="text-danger">
                                                                -{{ number_format($discount_total, 0, ',', '.') }} VNĐ</h5>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr class="table-order">
                                                        ...
                                                        <td colspan="2">
                                                            <h4 class="theme-color fw-bold">
                                                                {{ number_format($final_total, 0, ',', '.') }} VNĐ</h4>
                                                        </td>
                                                    </tr>
                                                </tfoot>
                                            </table>
                                        ...
                                        <div class="order-success">
                                            <div class="row g-4">
                                                ...
                                                <ul class="order-details">
                                                    ...
                                                    <li>{{ $order->address->district ?? '' }},
                                                        {{ $order->address->province ?? '' }}</li>
                                                ...
                                                <div class="delivery-sec">
                                                    ...
                                                    <a href="{{ route('admin.orders.tracking', $order->id) }}">Theo dõi đơn
                                                        hàng</a>
                                                </div>
