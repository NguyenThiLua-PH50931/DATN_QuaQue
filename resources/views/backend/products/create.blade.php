                        ...
                        <div class="col-sm-10 m-auto">
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    ...
                                    <form id="main-form" action="{{ route('admin.products.store') }}" method="POST"
                                        ...
                                        <ul class="nav nav-tabs mb-3" id="editProductTab" role="tablist">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" id="category-tab" data-bs-toggle="tab"
                                                    ...
                                                    aria-controls="category" aria-selected="false">Phân loại & Danh
                                                    mục</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" id="variant-tab" data-bs-toggle="tab"
                                                    data-bs-target="#variant" type="button" role="tab"
                                                    aria-controls="variant" aria-selected="false">Biến thể sản phẩm</button>
                                            </li>
                                        </ul>
                                        ...
                                        <div class="tab-content" id="editProductTabContent">
                                            ...
                                            <div class="tab-pane fade" id="variant" role="tabpanel"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio"
                                                                name="has_variants" id="hasVariantsYes" value="1"
                                                                {{ old('has_variants', 1) == 1 ? 'checked' : '' }}>
                                                            <label class="form-check-label" for="hasVariantsYes">Có biến
                                                                thể</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio"
                                                                name="has_variants" id="hasVariantsNo" value="0"
                                                                {{ old('has_variants', 1) == 0 ? 'checked' : '' }}>
                                                            <label class="form-check-label" for="hasVariantsNo">Không có
                                                                biến thể</label>
                                                        </div>
                                                    </div>
                                                    @error('has_variants')
                                                ...
                                                <div id="single-product-fields"
                                                    style="display: {{ old('has_variants', 1) == 0 ? 'block' : 'none' }};">
                                                    <div class="card mb-3">
                                                        <div class="card-body">
                                                ...
                                                <div id="variant-attribute-selection"
                                                    style="display: {{ old('has_variants', 1) == 1 ? 'block' : 'none' }};">
                                                    <div class="card mb-3">
                                                        <div class="card-body">
                                                                                ...
                                                                                @foreach ($attr->values as $val)
                                                                                    <label
                                                                                        ...
                                                                                        <input
                                                                                            ...
                                                                                            {{ old('attribute_values_checkbox.' . $attr->id) && in_array($val->id, old('attribute_values_checkbox.' . $attr->id)) ? 'checked' : '' }}>
                                                                                        <span
                                                    ...
                                                    <div class="card mb-4">
                                                        <div class="card-body">
                                                            ...
                                                            <p class="text-muted small">Biến thể sẽ được sinh tự động khi
                                                                chọn các giá trị thuộc tính.</p>
                                                                    ...
                                                                    @foreach (old('variants') as $i => $variant)
                                                                        <div
                                                                            ...
                                                                            <div class="row mt-3">
                                                                                <div class="col-12">
                                                                                    <div class="mb-3">
                                                                                        <label class="form-label">Thay đổi
                                                                                            ảnh biến thể</label>
                                                                                        <input type="file"
                                        ...
                                        <div class="mb-3 mt-3">
                                            ...
                                            <select name="active" class="form-select">
                                                <option value="1" {{ old('active', 1) == 1 ? 'selected' : '' }}>Có
                                                </option>
                                                <option value="0" {{ old('active', 1) == 0 ? 'selected' : '' }}>Không
                                                </option>
                                            </select>
                                        </div>
