                ...
                <div class="col-sm-12">
                    <div class="card card-table">
                        <div class="card-body">
                            ...
                            <div class="table-responsive region-table">
                                <table class="table all-package theme-table" id="table_id">
                                    ...
                                    <tbody>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="5" class="py-4 px-4 text-center">Không tìm thấy vùng miền
                                                    nào.</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                            ...
                            <form id="bulk-delete-form" action="{{ route('admin.regions.bulkDelete') }}" method="POST"
                                style="display: none;">
                                @csrf
                                @method('DELETE')
                ...
                <div class="modal-body">
                    @if ($errors->has('name'))
                        <div class="alert alert-danger mb-0">
                            @if ($errors->first('name') == 'Tên vùng miền đã tồn tại, vui lòng chọn tên khác.')
                                Tên vùng miền đã tồn tại, vui lòng chọn tên khác
                            @else
                                {{ $errors->first('name') }}
                            @endif
                        </div>
