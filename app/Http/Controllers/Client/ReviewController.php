...
public function store(Request $request)
{
    ...
    if (
        ...
        || $orderItem->product_variant_value_id != $request->product_variant_value_id
    ) {
        return response()->json([
    ...
    // Lấy tên biến thể sản phẩm từ bảng product_variants
    $productVariant = ProductVariant::find($request->product_variant_value_id);
    $productVariantName = $productVariant ? $productVariant->name : null;
    ...
    // Lưu đánh giá mới, thêm trường product_variant_name
    $review = Review::create([
        ...
        'product_variant_name'    => $productVariantName, // thêm tên biến thể
